    ...
    <footer className="bg-zinc-950 border-t border-white/5 py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 w-full">
          <div className="text-2xl font-bold tracking-tighter md:w-1/3 md:text-left text-center">
            second<span className="text-primary">skate</span>
          </div>
          
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 text-sm text-muted-foreground md:w-1/3 w-full">
